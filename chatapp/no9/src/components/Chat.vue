...
<template>
  <div class="mx-auto my-5 px-4">
    <h1 class="text-h5 text-sm-h3 font-weight-medium">Vue.js Chat チャットルーム</h1>
    <div class="mt-10">
      ...
      <div class="mt-5 d-sm-flex">
        <v-btn color="primary" variant="flat" @click="onPublish" class="d-block">投稿</v-btn>
        <v-btn color="primary" variant="flat" class="ml-sm-1 mt-1 mt-sm-0" @click="onMemo">メモ</v-btn>
      </div>
