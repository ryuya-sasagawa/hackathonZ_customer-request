...
const onMemo = () => {
  // メモの内容を表示
  chatList.push(`${userName.value}さんのメモ：${convertBr(chatContent.value)}`)
  // 入力欄を初期化
  chatContent.value = ""
}
// #endregion
  ...
  <div class="mx-auto my-5 px-4">
    ...
    <div class="mt-10">
      ...
      <div class="mt-5" v-if="chatList.length !== 0">
        <ul>
          <li class="item mt-4" v-for="(chat, i) in chatList" :key="i"><p v-html="chat"></p></li>
        </ul>
      </div>
    </div>
