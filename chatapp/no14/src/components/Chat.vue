...
<template>
  <div class="mx-auto my-5 px-4">
    ...
    <div class="mt-10">
      <p>ログインユーザ：{{ userName }}さん<v-btn-toggle v-model="isPause" class="ml-2" density="compact"><v-btn size="small" variant="outlined" color="error">休止中</v-btn></v-btn-toggle></p>
